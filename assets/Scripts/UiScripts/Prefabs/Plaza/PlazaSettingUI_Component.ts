...
@ccclass("PlazaSettingUI_Component")
@menu("Hidden/PlazaSettingUI_Component")
export class PlazaSettingUI_Component extends ComponentController {
  ...
  protected onLoad(): void {
    ...
    this.setButtonClickEvent(
      "MainView/Content/ScrollView/view/content/MainContent/LogoutBtn",
      0,
      "onLogoutBtnClick",
      this.getClassName(),
    );
