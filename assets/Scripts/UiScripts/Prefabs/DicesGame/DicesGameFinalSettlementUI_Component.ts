...
import { DicesGameFinalSettlementItem_Component } from "./DicesGameFinalSettlementItem_Component";
import { DicesGameMainUI_Component } from "./DicesGameMainUI_Component";
const { ccclass, menu } = _decorator;

@ccclass("DicesGameFinalSettlementUI_Component")
@menu("Hidden/DicesGameFinalSettlementUI_Component")
export class DicesGameFinalSettlementUI_Component extends ComponentController {
  ...
  // 结算数据
  private _data: Gateway.Returned.Games.DicesGame.PlayerFinalSettlementData[] =
    null;
   ...
   */
  public setData(
    data: Gateway.Returned.Games.DicesGame.PlayerFinalSettlementData[],
  ) {
    this._data = data;
    ...
    this._data.forEach((item) => {
      ...
      const component = node.addComponent(
        DicesGameFinalSettlementItem_Component,
      );
