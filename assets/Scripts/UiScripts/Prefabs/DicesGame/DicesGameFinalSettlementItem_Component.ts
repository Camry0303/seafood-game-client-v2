...
@ccclass("DicesGameFinalSettlementItem_Component")
@menu("Hidden/DicesGameFinalSettlementItem_Component")
export class DicesGameFinalSettlementItem_Component extends ComponentController {
  // 头像图片精灵
