 ...
 * 潮汕麻将游戏配置
 */
export type ChaoShanMahjongGameConfig = {
  /**
   * 游戏总局数
   */
 ...
 * 设置俱乐部潮汕麻将游戏配置参数
 */
export type SetClubChaoShanMahjongGameConfig = ChaoShanMahjongGameConfig & {
  /**
   * 俱乐部id
   */
  club_id: number;
 ...
 * 创建俱乐部潮汕麻将游戏房间
 */
export type CreateClubChaoShanMahjongGameRoom = ChaoShanMahjongGameConfig & {
  /**
   * 俱乐部id
   */
  club_id: number;
 ...
 * 创建公开潮汕麻将游戏房间
 */
export type CreatePublicChaoShanMahjongGameRoom = ChaoShanMahjongGameConfig;

/**
 * 俱乐部潮汕麻将游戏房间管理员解散
 */
export type AdminDissolveRoom = {
  /**
   * 俱乐部id
   */
  club_id: number;
 ...
 * 加入俱乐部潮汕麻将游戏房间
 */
export type JoinClubChaoShanMahjongGameRoom = {
  /**
   * 俱乐部id
   */
  club_id: number;
 ...
 * 离开俱乐部潮汕麻将游戏房间
 */
export type LeaveClubChaoShanMahjongGameRoom = {
  /**
   * 俱乐部id
   */
  club_id: number;
